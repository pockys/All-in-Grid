...
public enum IconListLib {
	...
	private IconListLib() {
		...
		// ////kinoko
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko001,
				"char_kinoko001", "char_kinoko001", 15));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko002,
				"char_kinoko002", "char_kinoko002", 16));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko003,
				"char_kinoko003", "char_kinoko003", 17));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko004,
				"char_kinoko004", "char_kinoko004", 18));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko005,
				"char_kinoko005", "char_kinoko005", 19));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko006,
				"char_kinoko006", "char_kinoko006", 20));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko007,
				"char_kinoko007", "char_kinoko007", 21));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko008,
				"char_kinoko008", "char_kinoko008", 22));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko009,
				"char_kinoko009", "char_kinoko009", 23));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko010,
				"char_kinoko010", "char_kinoko001", 24));
		kinokodata.add(new IconInfo(R.drawable.ic_char_kinoko011,
				"char_kinoko011", "char_kinoko011", 25));

		// /////strange

		strange.add(new IconInfo(R.drawable.ic_char_strange001,
				"char_strange001", "char_strange001", 31));
		strange.add(new IconInfo(R.drawable.ic_char_strange002,
				"char_strange002", "char_strange002", 32));
		strange.add(new IconInfo(R.drawable.ic_char_strange003,
				"char_strange003", "char_strange001", 33));
		strange.add(new IconInfo(R.drawable.ic_char_strange004,
				"char_strange004", "char_strange004", 34));
		strange.add(new IconInfo(R.drawable.ic_char_strange005,
				"char_strange005", "char_strange005", 35));
		strange.add(new IconInfo(R.drawable.ic_char_strange006,
				"char_strange006", "char_strange006", 36));
		strange.add(new IconInfo(R.drawable.ic_char_strange007,
				"char_strange007", "char_strange007", 37));
		strange.add(new IconInfo(R.drawable.ic_char_strange008,
				"char_strange008", "char_strange008", 38));
		...
		tizukigou.add(new IconInfo(R.drawable.ic_char_tizukigou001,
				"char_tizukigou001", "char_tizukigou001", 1));

		tizukigou.add(new IconInfo(R.drawable.ic_char_tizukigou002,
				"char_tizukigou002", "char_tizukigou002", 2));

		tizukigou.add(new IconInfo(R.drawable.ic_char_tizukigou003,
				"char_tizukigou003", "char_tizukigou003", 3));
		...
		ListView.add(new IconInfo(R.drawable.ic_char_tizukigou001,
				"char_tizukigou001", "char_tizukigou001", 1));
